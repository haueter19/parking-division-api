...
async def get_work_orders(
    ...
    query = text("""
        SELECT
            ...
            RequestedBy,
            TemplateId
        FROM cityworks.WorkOrder
        WHERE TemplateId = '217'
...
async def get_filter_options(
    ...
    # TODO: Update queries once actual data source is confirmed
    # Placeholder structure for filter options

    filters['statuses'] = []  # Distinct work order statuses
    filters['submit_to_options'] = []  # Distinct submit to values
    filters['parent_templates'] = []  # Distinct parent template descriptions
    filters['requested_by_options'] = []  # Distinct requested by values
